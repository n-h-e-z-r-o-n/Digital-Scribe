...
def settings(widget):
    ...
    themes_change = tk.Button(g2, text=current_theme, bg=bg_color, fg=fg_color, borderwidth=0, border=1, font=("Courier New", 10), command=lambda : change_color(root, ))
...
def User_Home_page(widget):
    ...
    profile_widget = tk.Button(side_bar, bg=bg_color, text='≣', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0)  # ,command=lambda: (PROFILE_widget.tkraise(), active(profile_widget)))
    ...
    st1_bt = tk.Button(side_bar, bg=bg_color, text='📞', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CALL_Widget.tkraise(), active(st1_bt)))
    ...
    st2_bt = tk.Button(side_bar, bg=bg_color, text='🎥', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CHAT_Widget.tkraise(), active(st2_bt)))
    ...
    st3_bt = tk.Button(side_bar, bg=bg_color, text='📩', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CONV_AI_Widget.tkraise(), active(st3_bt)))
    ...
    st4_bt = tk.Button(side_bar, bg=bg_color, text='☏', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CONV_AI_Widget.tkraise(), active(st4_bt)))
    ...
    st5_bt = tk.Button(side_bar, bg=bg_color, text='☏', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CONV_AI_Widget.tkraise(), active(st5_bt)))
    ...
    st6_bt = tk.Button(side_bar, bg=bg_color, text='☏', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CONV_AI_Widget.tkraise(), active(st6_bt)))
    ...
    st7_bt = tk.Button(side_bar, bg=bg_color, text='☏', font=("Calibri", 20), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (CONV_AI_Widget.tkraise(), active(st7_bt)))
    ...
    st8_bt = tk.Button(side_bar, bg=bg_color, text='⚙ ', font=("Calibri", 20, 'bold'), fg=fg_color, anchor='center', borderwidth=0, border=0, command=lambda: (SETTINGS_Widget.tkraise(), active(st8_bt)))
