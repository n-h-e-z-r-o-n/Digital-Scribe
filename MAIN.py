...
def settings(widget):
    ...
    change_bg_OnHover(gradient_access_widget, 'green', 'lightgreen')
    ...
    gradient_work_widget = tk.Entry(g1, borderwidth=0, border=1, font=("Courier New", 10))
    ...
    tk.Label(g1, text="ASSEMBLY-AI  ", font=("Georgia", 12, 'bold'), anchor='w', borderwidth=0, border=0).place(relheight=0.07, relwidth=0.6, rely=0.22, relx=0)
    ...
    assembly_widget = tk.Entry(g1, borderwidth=0, border=1, font=("Courier New", 10))
    ...
    save = tk.Button(g1, text="save ", font=("Calibri", 12, 'bold'), borderwidth=0, border=0, command=lambda: save_keys(gradient_access_widget.get(), gradient_work_widget.get(), assembly_widget.get()) )
