...
def RAG_page(widget):
    ...
    tk.Button(conversation_widget, text="Record", bg=bg_color, activebackground=bg_color, fg=fg_color, font=("Times New Roman", 13), borderwidth=2, border=3,  command=lambda: RUN_OFFLINE_speech_recognition(widget=None) ).place(relheight=0.03, relwidth=0.07, rely=0.65, relx=0.152)
