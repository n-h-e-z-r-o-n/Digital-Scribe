...
def chat(widget):
    ...
    def add(widget):
        ...
        style = ttk.Style()
        style.configure("Custom.TCheckbutton", background='green', foreground="blue")
        ...
        checkbox = ttk.Checkbutton(new_entity, style="Custom.TCheckbutton", variable=chk_var, offvalue=False)
