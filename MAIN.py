...
def conversation(widget):
    ...
    t2 = tk.Entry(conversation_widget, bg=bg_color, fg=fg_color, relief=tk.SUNKEN, font=("Times New Roman", 13), borderwidth=2, border=1)
    t2.place(relheight=0.05, relwidth=0.6, rely=0.7, relx=0.01)
