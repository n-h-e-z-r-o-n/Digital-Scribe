...
def chat(widget):
    ...
    def add(widget):
        ...
        tk.Entry(new_entity, bg=bg_color, borderwidth=0, border=1, font=("Bauhaus 93", 11)).place(relx=0.01, rely=0, relwidth=0.5, relheight=0.9)
        tk.Button(new_entity, bg=bg_color, relief=tk.SUNKEN, borderwidth=0, border=1).place(relx=0.52, rely=0, relwidth=0.2, relheight=0.9)
        tk.Button(new_entity, bg=bg_color, activebackground=bg_color, text="X", borderwidth=0, border=0, font=("Bauhaus 93", 11), command=lambda: delet_widget(new_entity)).place(relx=0.95, rely=0, relwidth=0.05, relheight=1)
