...
def conversation(widget):
    ...
    tk.Button(conversation_widget, text="Upload doc", bg=bg_color, fg=fg_color, font=("Times New Roman", 13), borderwidth=2, border=3).place(relheight=0.03, relwidth=0.07, rely=0.65, relx=0.081)
