...
def chat_me(widget):
    ...
    tk.Button(chatbot_widget, text='↥', font=("Times New Roman", 14), bg=bg_color, fg=fg_color, activebackground=bg_color, activeforeground=fg_color, borderwidth=0, border=0).place(relheight=0.03, relwidth=0.02, rely=0.92, relx=0.8)
