    ...
    def audio_recodings(frame_widget, cavas_widget):
        ...
        if os.path.exists(folder_path):
            ...
            for audio_file in file_list:
                ...
                audio_download_btn = tk.Label(audio_wid, text="d", bg="white", font=("Calibri", font_size), borderwidth=0, border=0)
                audio_download_btn.place(relheight=1, relwidth=0.1, rely=0, relx=0.8)
                audio_push_btn = tk.Label(audio_wid, text="p", bg="white", font=("Calibri", font_size), borderwidth=0, border=0)
