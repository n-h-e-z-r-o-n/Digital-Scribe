...
def chat(widget):
    ...
    def add(widget):
        ...
        tk.Entry(new_entity, bg=bg_color, borderwidth=0, border=1).place(relx=0.01, rely=0, relwidth=0.5, relheight=0.9)
        tk.Button(new_entity, bg=bg_color, borderwidth=0, border=1).place(relx=0.52, rely=0, relwidth=0.2, relheight=0.9)
