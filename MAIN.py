...
def conversation(widget):
    ...
    tk.Button(conversation_widget, bg='blue', fg=fg_color, relief=tk.SUNKEN, font=("Times New Roman", 13), borderwidth=2, border=3).place(relheight=0.05, relwidth=0.98, rely=0.65, relx=0.01)
