...
def chat(widget):
    ...
    tk.Button(entity_section, text='+ Add new entity', borderwidth=0, border=0, command=lambda :add(user_page_widget)).place(relheight=0.03, relwidth=1, rely=0.97, relx=0)
