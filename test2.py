...
def create_floating_frame():
    ...
    BEN_00 = tk.Entry(container3, borderwidth=0, border=1, bg=bg_color, fg=fg_color, font=("Times New Roman", 11))
    BEN_00.place(relheight=0.07, relwidth=0.4, relx=0.05, rely=0.05)
    pop_DEN_00 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, BEN_00, "Hel"))
    ...
    lB_11.place(relheight=0.05, relwidth=0.4, relx=0.55, rely=0)
    REN_11 = tk.Entry(container3, borderwidth=0, border=1, bg=bg_color, fg=fg_color, font=("Times New Roman", 11))
    REN_11.place(relheight=0.07, relwidth=0.4, relx=0.55, rely=0.05)
    pop_DEN_11 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, REN_11, "Hel"))
    ...
    EN_22.place(relheight=0.07, relwidth=0.4, relx=0.05, rely=0.19)
    pop_DEN_22 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_22, "Hel"))
    ...
    pop_DEN_33 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_33, "Hel"))
    ...
    pop_DEN_55 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_44, "Hel"))
    ...
    pop_DEN_66 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_55, "Hel"))
    ...
    pop_DEN_66 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_66, "Hel"))
    pop_DEN_66.place(relheight=0.05, relwidth=0.015, relx=0.45, rely=0.47)

    lB_77 = tk.Label(container3, borderwidth=0, border=0, text="Height (cm)", bg=bg_color, fg=fg_color, anchor="sw", font=("Times New Roman", 11))
    lB_77.place(relheight=0.05, relwidth=0.4, relx=0.55, rely=0.42)
    EN_77 = tk.Entry(container3, borderwidth=0, border=1, bg=bg_color, fg=fg_color, font=("Times New Roman", 11))
    EN_77.place(relheight=0.07, relwidth=0.4, relx=0.55, rely=0.47)
    pop_DEN_77 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_77, "Hel"))
    pop_DEN_77.place(relheight=0.05, relwidth=0.015, relx=0.95, rely=0.47)

    lB_88 = tk.Label(container3, borderwidth=0, border=0, bg=bg_color, fg=fg_color, text="Weight (KG)", anchor="sw", font=("Times New Roman", 11))
    lB_88.place(relheight=0.05, relwidth=0.4, relx=0.05, rely=0.56)
    EN_88 = tk.Entry(container3, borderwidth=0, border=1, bg=bg_color, fg=fg_color, font=("Times New Roman", 11))
    EN_88.place(relheight=0.07, relwidth=0.4, relx=0.05, rely=0.61)
    pop_DEN_88 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_88, "Hel"))
    ...
    pop_DEN_00 = tk.Button(container3, text="V", bg=bg_color, font=("Bauhaus 93", 11), activebackground=bg_color, activeforeground=fg_color, fg=fg_color, borderwidth=0, border=0, command=lambda: Show_PopUp(container3, EN_11, "Hel"))
